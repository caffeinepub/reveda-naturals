...
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: string, arg1: bigint, arg2: string, arg3: string): Promise<bigint> {
    ...
    async getBrandMission(): Promise<string> {
        if (this.processError) {
            try {
                const result = await this.actor.getBrandMission();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCartContents(): Promise<Array<[bigint, CartItem]>> {
        if (this.processError) {
            try {
    ...
    async getContactForms(): Promise<Array<[bigint, ContactForm]>> {
        if (this.processError) {
            try {
    ...
    async updateBrandMission(arg0: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateBrandMission(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
