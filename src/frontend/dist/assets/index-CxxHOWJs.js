...
const PACK_SIZES = ["100g", "250g", "500g"];
const REVIEWS = [
  {
    name: "Priya S.",
    location: "Delhi",
    quote: "The roasted makhana is absolutely delicious! Finally a healthy snack that actually tastes amazing. Will order again!"
  },
  {
    name: "Rahul M.",
    location: "Mumbai",
    quote: "Best quality moringa powder I've ever tried. You can tell it's pure and fresh. Highly recommend Riveda!"
  },
  {
    name: "Anita K.",
    location: "Bangalore",
    quote: "Ordered the turmeric and ginger powders. The aroma is incredible — nothing like store-bought. Truly natural!"
  },
  {
    name: "Vikram T.",
    location: "Lucknow",
    quote: "Fast delivery and premium packaging. The makhana varieties are top-notch. Great brand!"
  },
  {
    name: "Sunita R.",
    location: "Dehradun",
    quote: "The zeera powder has changed my cooking! So aromatic and pure. My whole family loves Riveda products."
  }
];
function LogoMark() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", style: { cursor: "pointer" }, children: [
...
function ProductCard({
  ...
  const [selected, setSelected] = reactExports.useState("100g");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "product-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { overflow: "hidden", position: "relative" }, children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "product-card-body", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "product-card-name", children: product.name }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pack-selector", children: PACK_SIZES.map((size) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "product-card-price", children: [
        "₹",
        product.prices[selected]
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
...
function CartDrawer({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-drawer", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-header", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "Your Cart" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "cart-items", children: items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-empty", "data-ocid": "cart.empty_state", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { style: { fontSize: "2rem", marginBottom: "0.75rem" }, children: "🌿" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Start adding naturally good products!"
            }
          )
          ...
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: item.product.image, alt: item.product.name }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-item-info", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "cart-item-name", children: item.product.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "cart-item-pack", children: item.pack }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "cart-item-price", children: [
                  "₹",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "qty-controls", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "qty-count", children: item.qty }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "button",
                        {
                          type: "button",
          ...
          `${item.product.id}-${item.pack}`
        )) }),
        items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-footer", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "cart-subtotal", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Free shipping on orders above ₹499"
            }
          )
        ] })
      ] })
...
function App() {
  ...
  function addToCart(product, pack) {
    setCartItems((prev) => {
      ...
      if (existing)
        return prev.map(
          (i) => i.product.id === product.id && i.pack === pack ? { ...i, qty: i.qty + 1 } : i
        );
      return [...prev, { product, pack, qty: 1 }];
    });
    setCartOpen(true);
  }
  function updateQty(id, pack, delta) {
    setCartItems(
      (prev) => prev.map(
        (i) => i.product.id === id && i.pack === pack ? { ...i, qty: i.qty + delta } : i
      ).filter((i) => i.qty > 0)
    );
  }
  function removeItem(id, pack) {
    setCartItems(
      (prev) => prev.filter((i) => !(i.product.id === id && i.pack === pack))
    );
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "announcement-bar", "data-ocid": "header.panel", children: "🌿 Free shipping on orders above ₹499  |  Rooted in Nature  |  100% Natural Products" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "site-header", "data-ocid": "header.section", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
          maxWidth: 1280,
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "svg",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M6 2 L3 6 L3 20 Q3 22 5 22 L19 22 Q21 22 21 20 L21 6 L18 2 Z" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M16 10 Q16 14 12 14 Q8 14 8 10" })
                      ]
                    }
                  ),
                  totalQty > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      style: {
                        position: "absolute",
    ...
    mobileMenuOpen && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mobile-menu-content", "data-ocid": "nav.modal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          type: "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { className: "hero-section", id: "hero", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hero-content animate-fade-up", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              style: {
              ...
              children: "Luxury Natural Care"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { children: "Rooted in Nature" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "Premium Makhana & Natural Spice Powders" }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              style: {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading", children: "Premium Selection" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading", children: "Curated Collections" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
                ...
                "data-ocid": "shop.list",
                children: PRODUCTS.map((product, idx) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `shop.item.${idx + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(ProductCard, { product, onAddToCart: addToCart }) }, product.id))
              }
            )
          ]
        }
        ...
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { overflow: "hidden", minHeight: 360 }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "img",
                  {
                    src: "/assets/generated/hero-flatlay.dim_1400x700.jpg",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { children: "The Riveda Promise" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "We believe that what goes into your body should come straight from nature — unprocessed, unadulterated, and full of life. Every product is sourced with intentionality from trusted farms and artisan producers across India." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "From the crisp lotus seeds of Bihar's wetlands to the sun-dried spice powders of Kerala and Rajasthan, Riveda Naturals brings you flavours and nutrition in their purest form." }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                          ...
                          children: [
                            ...
                            "Lab Tested",
                            "Eco Packaged"
                          ].map((b) => /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "promise-badge", children: b }, b))
                        }
                      )
                    ]
                  }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "section",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "makhana", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading", style: { textAlign: "left" }, children: "Customer Favourites" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: PRODUCTS.slice(0, 3).map((product, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      className: "product-card",
                      "data-ocid": `bestseller.item.${idx + 1}`,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { overflow: "hidden" }, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          "img",
                          {
                            src: product.image,
                            alt: product.name,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { id: "founders", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading", style: { textAlign: "left" }, children: "The People Behind" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "h2",
                {
                  className: "section-heading",
                ...
                "div",
                {
                  ...
                  children: [
                    ...
                    "div",
                    {
                      ...
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "founder-avatar", children: f.initial }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "founder-name", children: f.name }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "founder-role", children: f.role }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "founder-desc", children: f.desc })
                      ]
                    },
                    f.name
                  ))
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "p",
              {
                ...
                children: "A curated dining experience rooted in pure, natural ingredients. Coming to Dehradun, Uttarakhand."
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 1280, margin: "0 auto" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading", children: "Verified Buyers" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading", children: "Customer Love" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "section",
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: { maxWidth: 900, margin: "0 auto" }, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-subheading", children: "Get in Touch" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "section-heading", children: "Contact Us" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "section-divider" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "div",
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                    ...
                    ].map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "contact-info-item", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "contact-icon", children: item.icon }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "contact-label", children: item.label }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "contact-value", children: item.value })
                      ] })
                    ] }, item.label)),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "a",
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: submitContact, "data-ocid": "contact.panel", children: formSent ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    "div",
                    {
                      style: {
                        padding: "2rem",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "site-footer", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  ...
                  children: "Premium natural makhana and spice powders sourced directly from trusted Indian farms. Pure, unadulterated, and full of flavour."
                }
              )
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "footer-heading", children: "Quick Links" }),
              ["Shop All", "Makhana", "Spices", "About Us", "Blog"].map((l) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                "button",
                {
                  type: "button",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "footer-heading", children: "Info" }),
              [
                "Shipping Policy",
                "Returns",
                "Privacy Policy",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "footer-heading", children: "Stay Connected" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "p",
                {
                  style: {
                  ...
                  children: "Get exclusive offers and nature-inspired wellness tips."
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "a",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-bottom", children: [
        ...
        " Riveda Naturals. All rights reserved.  |  ",
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: "https://www.instagram.com/rivedanaturals",
...
Service({
  ...
  "getBrandMission": Func([], [Text], ["query"]),
  "getCartContents": Func(
    [],
    [Vec(Tuple(Nat, CartItem))],
    ["query"]
  ),
  "getCartTotal": Func([], [Nat], ["query"]),
  "getContactForms": Func(
    [],
    [Vec(Tuple(Nat, ContactForm))],
    ["query"]
  ),
  "getProduct": Func([Nat], [Product], ["query"]),
  "getProducts": Func(
    [],
    [Vec(Tuple(Nat, Product))],
    ["query"]
  ),
  "removeFromCart": Func([Nat], [], []),
  "submitContactForm": Func([Text, Text, Text], [Nat], []),
  "updateBrandMission": Func([Text], [], [])
});
